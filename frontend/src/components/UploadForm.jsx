...
function UploadForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!mixedAudio || !scammerAudio || !keyword) {
    ...
    <div className="shell">
      ...
      <div className="panel panel--left">
        ...
        <div className="topbar">
          ...
          <div>
            <h1 className="title">
              Speech<span className="highlight">Disentangle</span>
            </h1>

            <p className="subtitle">
              Scammer Voice Isolation & Keyword Detection
            </p>
          </div>
        ...
        >
          ...
          <div className="section">
            ...
            <input
              ...
              accept=".wav,.mp3"
              onChange={(e) =>
                setMixedAudio(e.target.files[0])
              }
            />
          ...
          <div className="section">
            ...
            <input
              ...
              accept=".wav,.mp3"
              onChange={(e) =>
                setScammerAudio(e.target.files[0])
              }
            />
      ...
      <div className="panel panel--right">
        ...
        <div className="results-header">
          ...
          {result && (
            <span
              className={`found-badge ${result.found
                  ? "found-badge--yes"
                  : "found-badge--no"
                }`}
            >
          ...
          <div className="results-body">
            ...
            {result.confidence_gate && (
              <div className={`confidence-card ${result.confidence_gate.passed ? 'confidence-card--passed' : 'confidence-card--failed'}`} style={{
                ...
                marginBottom: '20px',
                borderRadius: '8px',
                backgroundColor: result.confidence_gate.passed ? 'rgba(34, 197, 94, 0.1)' : 'rgba(239, 68, 68, 0.1)',
                border: `1px solid ${result.confidence_gate.passed ? 'rgba(34, 197, 94, 0.3)' : 'rgba(239, 68, 68, 0.3)'}`
              }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <span style={{ fontSize: '24px', fontWeight: 'bold' }}>
                    {(result.confidence_gate.confidence_score * 100).toFixed(1)}%
                  </span>
                  <span style={{ 
                    fontWeight: 'bold', 
                    color: result.confidence_gate.passed ? '#4ade80' : '#f87171' 
                  }}>
                    {result.confidence_gate.passed ? '✓ PASSED' : '⚠ LOW CONFIDENCE'}
                  </span>
                </div>
                {!result.confidence_gate.passed && result.warning && (
            ...
            {result.matches &&
              ...
              <p className="no-matches">
                No keyword occurrences detected.
              </p>
